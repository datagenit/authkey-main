...
export const metadata = {
    title: "Sample code for sending Voice call in PHP | Voice API code in PHP - Authkey.io",
    description: "Learn sample code for sending Voice in PHP. Voice call API in PHP designed for sending Voice OTP, verification calls and more. know more about integration.",
    alternates: {
        canonical: "https://authkey.io/sample-code-for-sending-voice-in-php",
    },
};
const SampleCodeforVoiceinPHP = () => {
    return (
        <div>
                ...
                <div className="container">
                    <div className="row row-grid">
                        ...
                        <div className="col-lg-9 m-0 ">
                            ...
                            <h3> Sample Code For Sending Voice in Php</h3>
...
export default SampleCodeforVoiceinPHP;