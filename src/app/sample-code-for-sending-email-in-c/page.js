...
export const metadata = {
    title: "Sample code for sending email in C | Email API code in C- Authkey.io",
    description: "Learn sample code for sending Email in C. Email API in C designed for sending Email OTP, transactional Email, verification and more. know more about integration.",
    alternates: {
        canonical: "https://authkey.io/sample-code-for-sending-email-in-c",
    },
};
const SampleCodeforEmailinC = () => {
    return (
        <div>
                ...
                <div className="container">
                    ...
                    <div className="row row-grid">
                        ...
                        <div className="col-lg-9 m-0 ">
                            ...
                            <h3> Sample Code For Sending Email in C#</h3>
                          ...
                          <h4 id="sms" className="mt-5"> C# Sample Code For Send Email</h4>
                          <hr className="m-0"/>
...
export default SampleCodeforEmailinC;