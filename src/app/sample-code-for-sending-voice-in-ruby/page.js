...
export const metadata = {
    title: "Sample code for sending Voice call in Ruby | Voice API code in Ruby - Authkey.io",
    description: "Learn sample code for sending Voice call in Ruby. Voice call API in ruby designed for sending voice OTP, verification calls and more. know more about integration.",
    alternates: {
        canonical: "https://authkey.io/sample-code-for-sending-voice-in-ruby",
    },
};
const SampleCodeforVoiceinRuby = () => {
    return (
        <div>
                ...
                <div className="container">
                    <div className="row row-grid">
                        ...
                        <div className="col-lg-9 m-0 ">
                            <h3>Sample Code For Send Voice in Ruby</h3>
                            ...
                            <h4 id="sms" className="mt-5"> Ruby Sample Code For Send Voice</h4>
                            <hr className="m-0"/>
...
export default SampleCodeforVoiceinRuby;