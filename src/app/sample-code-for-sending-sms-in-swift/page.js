...
export const metadata = {
    title: "Sample code for sending SMS in Swift | SMS API code in Swift - Authkey.io",
    description: "Learn sample code for sending SMS in Swift. SMS API in Swift designed for sending SMS OTP, transactional SMS, verification SMS and more. know more about integration.",
    alternates: {
        canonical: "https://authkey.io/sample-code-for-sending-sms-in-swift",
    },
};
const SampleCodeforSmsSwift = () => {
    return (
        <div>
                ...
                <div className="container">
                    <div className="row row-grid">
                        ...
                        <div className="col-lg-9 m-0 ">
                            <h3>Sample Code For Sending SMS in Swift</h3>
...
export default SampleCodeforSmsSwift;