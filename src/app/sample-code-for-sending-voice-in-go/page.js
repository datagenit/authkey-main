...
export const metadata = {
    title: "Sample code for sending voice in go | Voice API code in Go - Authkey.io",
    description: "Learn sample code for sending voice in Go. Voice call API designed for sending Voice OTP, verification calls and more. know more about integration.",
    alternates: {
        canonical: "https://authkey.io/sample-code-for-sending-voice-in-go",
    },
};
const SampleCodeforVoiceinGo = () => {
    return (
        <div>
                ...
                <div className="container">
                    ...
                    <div className="row row-grid">
                        ...
                        <div className="col-lg-9 m-0 ">
                            ...
                            <h3> Sample Code For Send Voice in Go</h3>
                          ...
                          <h4 id="sms" className="mt-5"> Go Sample Code For Sending Voice</h4>
                          <hr className="m-0"/>
...
export default SampleCodeforVoiceinGo;