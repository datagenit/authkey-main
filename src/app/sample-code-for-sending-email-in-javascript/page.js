...
export const metadata = {
    title: "Sample code for sending email in javascript | Email API code in javascript - Authkey.io",
    description: "Learn sample code for sending Email in javascript. Email API in javascript designed for sending Email OTP, transactional Email, verification and more. know more about integration.",
    alternates: {
        canonical: "https://authkey.io/sample-code-for-sending-email-in-javascript",
    },
};
const SampleCodeforEmailinJavascript = () => {
    return (
        <div>
                ...
                <div className="container">
                    ...
                    <div className="row row-grid">
                        ...
                        <div className="col-lg-9 m-0 ">
                            <h3> Sample Code For Sending Email in javaScript</h3>
                            <p>Sending Email using Authkey APIs is a breeze and lightning fast. You can simply pass the message body, message sender, mobile number &amp; authkey in the API request to send sms instantly.</p>
                             <h4 id="sms" className="mt-5"> javaScript Sample Code For Send Email</h4>
                            <hr className="m-0"/>
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "https://api.authkey.io/request?authkey=AUTHKEY&email=RecepientEmail&mid=1001",
    "method": "GET"
  }
...
export default SampleCodeforEmailinJavascript;