...
export const metadata = {
    title: "Sample code for sending email in Go | Email API code in Go - Authkey.io",
    description: "Learn sample code for sending Email in Go . Email API designed for sending Email OTP, transactional emails and more. know more about integration.",
    alternates: {
        canonical: "https://authkey.io/sample-code-for-sending-email-in-go",
    },
};
const SampleCodeforEmailinGo = () => {
    return (
        <div>
                ...
                <div className="container">
                    ...
                    <div className="row row-grid">
                        ...
                        <div className="col-lg-9 m-0 ">
                            ...
                            <h3>Sample Code For Sending Email in Go</h3>
                            ...
                            <h4 id="sms" className="mt-5"> Go Sample Code For Send Email</h4>
                            <hr className="m-0"/>
...
export default SampleCodeforEmailinGo;