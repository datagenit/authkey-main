...
export const metadata = {
    title: "Sample code for sending email in Nodejs | Email API code in Nodejs- Authkey.io",
    description: "Learn sample code for sending Email in Nodejs. Email API in nodejs designed for sending Email OTP, transactional Email, verification and more. know more about integration.",
    alternates: {
        canonical: "https://authkey.io/sample-code-for-sending-email-in-nodejs",
    },
};
const SampleCodeforEmailinNodejs = () => {
    return (
        <div>
                ...
                <div className="container">
                    <div className="row row-grid">
                        ...
                        <div className="col-lg-9 m-0 ">
                          ...
                          <h3> Sample Code For Send Email in Node.Js</h3>
                          ...
                          <h4 id="sms" className="mt-5"> Node.js Sample Code For Sending Email</h4>
                          <hr className="m-0"/>
...
export default SampleCodeforEmailinNodejs;