...
export const metadata = {
    title: "Sample code for sending Voice call in powershell | Voice API code in powershell - Authkey.io",
    description: " Learn sample code for sending Voice in powershell. Voice call API in powershell designed for sending Voice OTP, verification calls and more. know more about integration.",
    alternates: {
        canonical: "https://authkey.io/sample-code-for-sending-voice-in-powershell",
    },
};
const SampleCodeforVoiceinPowershell = () => {
    return (
        <div>
                ...
                <div className="container">
                    <div className="row row-grid">
                        ...
                        <div className="col-lg-9 m-0 ">
                            <h3> Sample Code For Send Voice in Powershell</h3>
                            ...
                            <h4 id="sms" className="mt-5"> Powershell Sample Code For Sending Voice</h4>
                            <hr className="m-0"/>


                          <SyntaxHighlighter language="php" useInlineStyles={false} style={a11yDark}> 
                          {`
curl --request GET --url 'https://api.authkey.io/request?authkey=AUTHKEY&mobile=RecepientMobile&
...
export default SampleCodeforVoiceinPowershell;