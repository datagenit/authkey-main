...
export const metadata = {
    title: "Sample code for sending email in powershell | Email API code in powershell - Authkey.io",
    description: "Learn sample code for sending Email in powershell. Email API in powershell designed for sending Email OTP, transactional Email, verification and more. know more about integration.",
    alternates: {
        canonical: "https://authkey.io/sample-code-for-sending-email-in-powershell",
    },
};
const SampleCodeforEmailinPowershell = () => {
    return (
        <div>
                ...
                <div className="container">
                    ...
                    <div className="row row-grid">
                        ...
                        <div className="col-lg-9 m-0 ">
                          <h3> Sample Code For Send Emial in Powershell</h3>
                          ...
                          <h4 id="sms" className="mt-5"> Powershell Sample Code For Sending Email</h4>
                          <hr className="m-0"/>

                          <SyntaxHighlighter language="php" useInlineStyles={false} style={a11yDark}> 
                          {`
curl --request GET --url 'https://api.authkey.io/request?authkey=AUTHKEY&email=RecepientEmail&mid=1001' 
`}
                          </SyntaxHighlighter>
...
export default SampleCodeforEmailinPowershell;