...
export const metadata = {
    title: "Sample code for sending email in PHP | Email API code in Nodejs- Authkey.io",
    description: "Learn sample code for sending Email in PHP. Email API in PHP designed for sending Email OTP, transactional Email, verification and more. know more about integration.",
    alternates: {
      canonical: "https://authkey.io/sample-code-for-sending-email-in-php",
  },
};

const SampleCodeforEmailinPHP = () => {
    return (
        <div>
                ...
                <div className="container">
                    <div className="row row-grid">
                        ...
                        <div className="col-lg-9 m-0 "> 
                            <h3> Sample Code For Sending Email in PHP</h3>
                            ...
                            <h4 id="sms" className="mt-5"> Php Sample Code For Send SMS</h4>
                            <hr className="m-0"/>
...
curl_setopt_array($curl, array(
  CURLOPT_URL => "https://api.authkey.io/request?authkey=AUTHKEY&email=RecepientEmail&mid=1001",
...
export default SampleCodeforEmailinPHP;