...
export const metadata = {
    title: "Sample code for sending email in Swift | Email API code in Swift - Authkey.io",
    description: "Learn sample code for sending Email in Swift. Email API in Swift designed for sending Email OTP, transactional Email, verification and more. know more about integration.",
    alternates: {
        canonical: "https://authkey.io/sample-code-for-sending-email-in-swift",
    },
};
const SampleCodeforEmailinSwift = () => {
    return (
        <div>
                ...
                <div className="container">
                    ...
                    <div className="row row-grid">
                        ...
                        <div className="col-lg-9 m-0 ">
                            ...
                            <h3> Sample Code For Sending Email in Swift</h3>
                            ...
                            <h4 id="sms" className="mt-5"> Swift Sample Code For Send SMS</h4>
                            <hr className="m-0"/>
...
let request = NSMutableURLRequest(url: NSURL(string: "https://api.authkey.io/request?authkey=AUTHKEY&email=RecepientEmail&mid=1001")! as URL,
...
export default SampleCodeforEmailinSwift;