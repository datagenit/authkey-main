...
export const metadata = {
    title: "Sample code for sending SMS in Ruby | SMS API code in Ruby - Authkey.io",
    description: "Learn sample code for sending SMS in Ruby. SMS API in ruby designed for sending SMS OTP, transactional SMS, verification SMS and more. know more about integration.",
    alternates: {
        canonical: "https://authkey.io/sample-code-for-sending-sms-in-ruby",
    },
};
const SampleCodeforSmsinRuby = () => {
    return (
        <div>
                ...
                <div className="container">
                    <div className="row row-grid">
                        ...
                        <div className="col-lg-9 m-0 ">
                            <h3> Sample Code For Send SMS in Ruby</h3>
...
export default SampleCodeforSmsinRuby;