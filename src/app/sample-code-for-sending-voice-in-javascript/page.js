...
export const metadata = {
    title: "Sample code for sending voice call in Javascript | Voice API code in Javascript- Authkey.io",
    description: "Learn sample code for sending Voice call in Javascript. Voice API designed for sending Voice OTP, verification calls and more. know more about integration.",
    alternates: {
        canonical: "https://authkey.io/sample-code-for-sending-voice-in-javascript",
    },
};
const SampleCodeforVoiceinJavascript = () => {
    return (
        <div>
                ...
                <div className="container">
                    <div className="row row-grid">
                        ...
                        <div className="col-lg-9 m-0 ">
                            ...
                            <h3> Sample Code For Sending Voice in javaScript</h3>
                            ...
                            <h4 id="sms" className="mt-5"> javaScript Sample Code For Send Voice</h4>
                            <hr className="m-0"/>
...
export default SampleCodeforVoiceinJavascript;