...
export const metadata = {
    title: "Sample code for sending SMS in Powershell | SMS API code in Powershell - Authkey.io",
    description: "Learn sample code for sending SMS in Powershell. SMS API in Powershell designed for sending SMS OTP, transactional SMS, verification SMS and more. know more about integration.",
    alternates: {
        canonical: "https://authkey.io/sample-code-for-sending-sms-in-powershell",
    },
};
const SampleCodeforSmsinPowershell = () => {
    return (
        <div>
                ...
                <div className="container">
                    <div className="row row-grid">
                        ...
                        <div className="col-lg-9 m-0 ">
                            <h3> Sample Code For Send SMS in Powershell</h3>
                            ...
                            <h4 id="sms" className="mt-5"> Powershell Sample Code For Sending SMS</h4>
                             <hr className="m-0"/>


                          <SyntaxHighlighter language="php" useInlineStyles={false} style={a11yDark}> 
                          {`
curl --request GET --url 'https://api.authkey.io/request?authkey=YourAuthKey&
...
export default SampleCodeforSmsinPowershell;