...
export const metadata = {
    title: "Sample code for sending Voice call in Curl | Voice API code in Curl - Authkey.io",
    description: "Learn sample code for sending Voice in Curl. Voice call API in Curl designed for sending Voice OTP, verification calls and more. know more about integration.",
    alternates: {
        canonical: "https://authkey.io/sample-code-for-sending-voice-in-curl",
    },
};
const SampleCodeforVoiceinCurl = () => {
    return (
        <div>
                ...
                <div className="container">
                    ...
                    <div className="row row-grid">
                        ...
                        <div className="col-lg-9 m-0 ">
                            ...
                            <h3>Sample Code For Sending Voice in cURL</h3>
                            ...
                            <h4 id="sms" className="mt-5"> cURL Sample Code For Send Voice</h4>
                            <hr className="m-0"/>


                          <SyntaxHighlighter language="php" useInlineStyles={false} style={a11yDark}> 
                          {`
curl -X GET 'https://api.authkey.io/request?authkey=AUTHKEY&mobile=RecepientMobile&
...
export default SampleCodeforVoiceinCurl;