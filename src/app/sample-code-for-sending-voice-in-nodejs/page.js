...
export const metadata = {
    title: "Sample code for sending Voice call in nodejs | Voice API code in nodejs - Authkey.io",
    description: "Learn sample code for sending Voice in nodejs. Voice call API in nodejs designed for sending Voice OTP, verification calls and more. know more about integration.",
    alternates: {
        canonical: "https://authkey.io/sample-code-for-sending-voice-in-nodejs",
    },
};
const SampleCodeforVoiceinNodejs = () => {
    return (
        <div>
                ...
                <div className="container">
                    <div className="row row-grid">
                        ...
                        <div className="col-lg-9 m-0 ">
                            ...
                            <h3> Sample Code For Send Voice in Node.js</h3>
                            ...
                            <h4 id="sms" className="mt-5"> Node.js Sample Code For Sending SMS</h4>
                            <hr className="m-0"/>
...
export default SampleCodeforVoiceinNodejs;