...
export const metadata = {
    title: "Sample code for sending SMS in nodejs | SMS API code in nodejs - Authkey.io",
    description: "Learn sample code for sending SMS in nodejs. SMS API in nodejs designed for sending SMS OTP, transactional SMS, verification SMS and more. know more about integration.",
    alternates: {
        canonical: "https://authkey.io/sample-code-for-sending-sms-in-nodejs",
    },
};
const SampleCodeforSmsinNodejs = () => {
    return (
        <div>
...
export default SampleCodeforSmsinNodejs;