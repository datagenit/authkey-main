...
export const metadata = {
    title: "Sample code for sending Voice call in python | Voice API code in python- Authkey.io",
    description: "Learn sample code for sending Voice in python. Voice call API in python designed for sending Voice OTP, verification calls and more. know more about integration.",
    alternates: {
        canonical: "https://authkey.io/sample-code-for-sending-voice-in-python",
    },
};
const SampleCodeforVoiceinPython = () => {
    return (
        <div>
                ...
                <div className="container">
                    <div className="row row-grid">
                        ...
                        <div className="col-lg-9 m-0 ">
                            ...
                            <h3> Sample Code For Sending Voice in Python</h3>
                            ...
                            <h4 id="sms" className="mt-5"> Python Sample Code For Send Voice</h4>
                            <hr className="m-0"/>
...
conn.request("GET", "/request?authkey=AUTHKEY&mobile=RecepientMobile&
...
export default SampleCodeforVoiceinPython;