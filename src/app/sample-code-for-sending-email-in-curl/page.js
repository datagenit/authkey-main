...
export const metadata = {
    title: "Sample code for sending email in curl | Email API code in curl - Authkey.io",
    description: "Learn sample code for sending Email in curl. Email API in curl designed for sending Email OTP, transactional Email, verification and more. know more about integration.",
    alternates: {
        canonical: "https://authkey.io/sample-code-for-sending-email-in-curl",
    },
};
const SampleCodeforEmailinCurl = () => {
    return (
        <div>
                ...
                <div className="container">
                    <div className="row row-grid">
                        ...
                        <div className="col-lg-9 m-0 ">
                            <h3> Sample Code For Sending Email in cURL</h3>
                            ...
                            <h4 id="sms" className="mt-5"> cURL Sample Code For Send Email</h4>
                            <hr className="m-0"/>
                            <SyntaxHighlighter language="php" useInlineStyles={false} style={a11yDark}> 
                          {`
curl -X GET 'https://api.authkey.io/request?authkey=AUTHKEY&email=RecepientEmail&mid=1001' 
...
export default SampleCodeforEmailinCurl;