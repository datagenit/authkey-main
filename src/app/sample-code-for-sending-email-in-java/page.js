...
export const metadata = {
    title: "Sample code for sending email in Java | Email API code in Java - Authkey.io",
    description: "Learn sample code for sending Email in Java. Email API in Java designed for sending Email OTP, transactional Email, verification and more. know more about integration.",
    alternates: {
        canonical: "https://authkey.io/sample-code-for-sending-email-in-java",
    },
};
const SampleCodeforEmailinJava = () => {
    return (
        <div>
                ...
                <div className="container">
                    <div className="row row-grid">
                        ...
                        <div className="col-lg-9 m-0 ">
                            ...
                            <h3> Sample Code For Sending Email in JAVA</h3>
                            ...
                            <h4 id="sms" className="mt-5"> JAVA Sample Code For Send Email</h4>
                            <hr className="m-0"/>
...
export default SampleCodeforEmailinJava;