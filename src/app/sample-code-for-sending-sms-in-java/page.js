...
export const metadata = {
    title: "Sample code for sending SMS in Java | SMS API code in Java - Authkey.io",
    description: "Learn sample code for sending SMS in Java. SMS API in Java designed for sending SMS OTP, transactional SMS, verification SMS and more. know more about integration.",
    alternates: {
        canonical: "https://authkey.io/sample-code-for-sending-sms-in-java",
    },
};
const SampleCodeforSmsinJava = () => {
    return (
        <div>
                ...
                <div className="container">
                    <div className="row row-grid">
                        ...
                        <div className="col-lg-9 m-0 ">
                            <h3> Sample Code For Sending SMS in JAVA</h3>
                            ...
                            <h4 id="sms" className="mt-5"> JAVA Sample Code For Send SMS</h4>
                            <hr className="m-0"/>
...
export default SampleCodeforSmsinJava;