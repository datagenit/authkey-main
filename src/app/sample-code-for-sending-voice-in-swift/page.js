...
export const metadata = {
    title: "Sample code for sending Voice call in Swift | Voice API code in Swift - Authkey.io",
    description: "Learn sample code for sending Voice call in Swift. Voice call API in Swift designed for sending voice OTP, verification calls and more. know more about integration.",
    alternates: {
        canonical: "https://authkey.io/sample-code-for-sending-voice-in-swift",
    },
};
const SampleCodeforVoiceinSwift = () => {
    return (
        <div>
                ...
                <div className="container">
                    <div className="row row-grid">
                        ...
                        <div className="col-lg-9 m-0 ">
                            <h3> Sample Code For Sending Voice in Swift</h3>
...
export default SampleCodeforVoiceinSwift;